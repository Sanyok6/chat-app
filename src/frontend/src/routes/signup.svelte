      ...
      <form class="mt-8 space-y-6" on:submit|preventDefault={handleLogin}>
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            ...
            <input id="username" bind:value={username} name="username" type="username" autocomplete="username" required class="input-field rounded-t-md" placeholder="Email address">
          </div>
          <div>
            <label for="email-address" class="sr-only">Email address</label>
            <input id="email-address" bind:value={email} name="email" type="email" autocomplete="email" required class="input-field rounded-t-md" placeholder="Email address">
          </div>
          <div>
...
<style lang="postcss">
.input-field {
    @apply appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300
